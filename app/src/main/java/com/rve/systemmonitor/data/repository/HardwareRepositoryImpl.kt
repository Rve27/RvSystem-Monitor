...
class HardwareRepositoryImpl @Inject constructor(
    ...
    private val gpuStaticInfo by lazy {
        ...
        GPU(
            ...
            numCompressedTextureFormats = GpuUtils.getNumCompressedTextureFormats(),
            ...
            vulkanInstanceExtensionsCount = GpuUtils.getVulkanInstanceExtensionsCount(),
            vulkanInstanceExtensions = GpuUtils.getVulkanInstanceExtensions().toImmutableList(),
