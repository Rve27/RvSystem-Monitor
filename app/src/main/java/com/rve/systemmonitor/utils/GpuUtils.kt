...
object GpuUtils {
    ...
    private var cachedMaxVertexUniformBlocks: Int? = null
    ...
    fun getGpuDetails(): Triple<String, String, Pair<Int, Int>> {
        ...
        return runCatching {
            ...
            cachedMaxVaryingVectors = maxVaryingVectors[0]
            ...
            cachedMaxVertexUniformVectors = maxVertexUniformVectors[0]
            ...
            val maxVertexUniformBlocks = IntArray(1)
            GLES30.glGetIntegerv(GLES30.GL_MAX_VERTEX_UNIFORM_BLOCKS, maxVertexUniformBlocks, 0)
            cachedMaxVertexUniformBlocks = maxVertexUniformBlocks[0]

            val maxFragmentUniformBlocks = IntArray(1)
            GLES30.glGetIntegerv(GLES30.GL_MAX_FRAGMENT_UNIFORM_BLOCKS, maxFragmentUniformBlocks, 0)
            cachedMaxFragmentUniformBlocks = maxFragmentUniformBlocks[0]

            val maxCombinedUniformBlocks = IntArray(1)
            GLES30.glGetIntegerv(GLES30.GL_MAX_COMBINED_UNIFORM_BLOCKS, maxCombinedUniformBlocks, 0)
            cachedMaxCombinedUniformBlocks = maxCombinedUniformBlocks[0]
    ...
    fun getMaxVaryingVectors(): Int {
        cachedMaxVaryingVectors?.let { return it }
        getGpuDetails()
        return cachedMaxVaryingVectors ?: 0
    }

    fun getMaxVertexUniformVectors(): Int {
        cachedMaxVertexUniformVectors?.let { return it }
        getGpuDetails()
        return cachedMaxVertexUniformVectors ?: 0
    }

    fun getMaxFragmentUniformVectors(): Int {
    ...
    fun getMaxVertexTextureImageUnits(): Int {
    ...
    fun getMaxArrayTextureLayers(): Int {
    ...
    fun getMaxVertexUniformBlocks(): Int {
        cachedMaxVertexUniformBlocks?.let { return it }
        getGpuDetails()
        return cachedMaxVertexUniformBlocks ?: 0
    }

    fun getMaxFragmentUniformBlocks(): Int {
        cachedMaxFragmentUniformBlocks?.let { return it }
        getGpuDetails()
        return cachedMaxFragmentUniformBlocks ?: 0
    }

    fun getMaxCombinedUniformBlocks(): Int {
        cachedMaxCombinedUniformBlocks?.let { return it }
        getGpuDetails()
        return cachedMaxCombinedUniformBlocks ?: 0
    }

    fun getMaxComputeUniformBlocks(): Int {
    ...
    fun getMaxTessControlUniformBlocks(): Int {
