    ...
    ScreenLazyColumn {
        ...
        item {
            StandardCard {
                ...
                InfoItem(
                    label = stringResource(R.string.gpu_label_gl_version),
                ...
                TwoColumnInfoRow(modifier = Modifier.padding(bottom = 16.dp)) {
                    ...
                    InfoItem(
                        label = stringResource(R.string.gpu_label_egl_version),
                        value = gpuInfo.eglVersion,
                        modifier = Modifier.weight(1f),
                    )
                }
                ...
                TwoColumnInfoRow(modifier = Modifier.padding(bottom = 16.dp)) {
                    ...
                    InfoItem(
                        label = stringResource(R.string.gpu_label_egl_vendor),
                        value = gpuInfo.eglVendor,
                        modifier = Modifier.weight(1f),
                    )
                }
        ...
        item {
            StandardCard {
                ...
                TwoColumnInfoRow(modifier = Modifier.padding(bottom = 16.dp)) {
                    ...
                    InfoItem(
                        label = stringResource(R.string.gpu_label_aliased_line_width),
                        value = if (gpuInfo.aliasedLineWidthRange.first > 0f || gpuInfo.aliasedLineWidthRange.second > 0f) {
                            "${gpuInfo.aliasedLineWidthRange.first} - ${gpuInfo.aliasedLineWidthRange.second}"
                        } else {
                            stringResource(R.string.value_unknown)
                        },
                        modifier = Modifier.weight(1f),
